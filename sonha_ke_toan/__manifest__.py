# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/nl_acc_pc_h_views.xml',
        'views/nl_acc_pt_h_views.xml',
        'views/nl_acc_hddv_h_views.xml',
        ...
        'views/nl_acc_ap_h_xhtl_views.xml',
        'views/nl_acc_ap_h_pxvt_views.xml',
        'views/danh_muc_phieu_in_views.xml',
        'wizard/thong_bao_wizard_views.xml',
        'wizard/popup_tim_kiem_views.xml',
        'wizard/popup_bao_cao_views.xml',
        'wizard/popup_bao_cao_dt_views.xml',
        ...
        'wizard/wizard_danh_muc_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            # 'sonha_ke_toan/static/src/js/list_column_width_persistence.js',
